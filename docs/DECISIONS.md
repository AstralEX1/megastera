...
| D-002 | `MEGAPLANETS_V1` remains the Megapot source tag | Preserves attribution without relying on a Planet NFT deployment. |
...
| D-009 | Leaderboard is a daily UTC PostgreSQL snapshot | Worker-owned mutation keeps public reads simple and bounded. |
