...
function RoadmapList({ items, muted = false, completed = false, future = false }: RoadmapListProps) {
  const reduceMotion = useReducedMotion();
  const textClass = future
    ? 'text-[rgba(150,154,173,0.78)]'
    : muted
      ? 'text-[var(--text-secondary)]'
      : 'text-[var(--text-primary)]';

  return (
    <ul className={`mt-5 space-y-3 text-sm ${textClass}`}>
...
function TimelineNode({
  ...
  const toneClass = tone === 'done'
    ...
    : tone === 'current'
      ...
      : 'border-[rgba(58,60,82,0.72)] bg-[rgba(9,10,18,0.82)] text-[rgba(150,154,173,0.72)]';
...
const futureCardClass =
  'rounded-2xl border border-[rgba(37,38,54,0.72)] bg-[rgba(9,10,18,0.82)] p-5 backdrop-blur-[2px] sm:p-6';
  ...
  return (
    <div className="relative isolate mx-auto max-w-4xl pb-10">
      <div className="pointer-events-none absolute bottom-[-2.5rem] left-1/2 top-[-2.5rem] z-0 w-screen -translate-x-1/2 overflow-hidden">
        <Galaxy density={0.58} glowIntensity={0.13} speed={0.18} />
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(3,3,7,0.36),rgba(3,3,7,0.08)_24%,rgba(3,3,7,0.14)_70%,rgba(3,3,7,0.48))]"
        />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div ref={timelineRef} className="relative mt-8">
          ...
          <div className="relative grid grid-cols-[32px_minmax(0,1fr)] gap-5 pb-8" data-roadmap-upcoming="true">
            <div />
            <div className="flex items-center gap-3">
              <span aria-hidden="true" className="h-px flex-1 bg-gradient-to-r from-transparent via-[var(--border)] to-[var(--border)]" />
              <span className="telemetry text-[var(--text-secondary)]">Upcoming</span>
          ...
          <FadeContent duration={0.52}>
            ...
            >
              ...
              <div className={futureCardClass}>
                <span className="telemetry text-[rgba(178,140,255,0.72)]">Season 2</span>
                <h2 className="mt-2 font-hud text-2xl font-semibold tracking-[-0.035em] text-[rgba(244,247,255,0.78)]">
                  Stellar Expansion
                </h2>
                <RoadmapList items={stellarExpansion} future />

                <details className="group relative mt-6 border-t border-[rgba(37,38,54,0.72)] pt-4">
                  <summary className="inline-flex cursor-pointer list-none items-center gap-2 rounded-lg text-xs font-semibold uppercase tracking-[0.1em] text-[rgba(174,185,255,0.78)] outline-none transition-colors hover:text-[var(--text-primary)] focus-visible:text-[var(--text-primary)]">
                    <motion.span
                      aria-hidden="true"
                      className="inline-flex h-6 w-6 items-center justify-center rounded-full border border-[var(--accent)]/30 bg-[var(--accent)]/5"
                      animate={
                        reduceMotion
                          ? undefined
                          : {
                              ...
                              boxShadow: [
                                ...
                                '0 0 12px rgba(174,185,255,0.12)',
                                '0 0 0 rgba(174,185,255,0)',
                              ],
                            }
                      }
                  ...
                  <div className="mt-3 max-w-xl rounded-xl border border-[rgba(37,38,54,0.72)] bg-[rgba(16,17,29,0.82)] p-4 text-sm leading-6 text-[rgba(150,154,173,0.82)] transition-opacity group-hover:opacity-100 group-focus-within:opacity-100 group-open:opacity-100 motion-reduce:transition-none">
          ...
          <FadeContent duration={0.52}>
            ...
            >
              ...
              <div className={futureCardClass}>
                <span className="telemetry text-[rgba(150,154,173,0.78)]">Season 3</span>
                <h2 className="mt-2 font-hud text-2xl font-semibold tracking-[-0.035em] text-[rgba(244,247,255,0.78)]">
                  Galactic Conflict
                </h2>
                <RoadmapList items={galacticConflict} future />
              </div>
            </section>
          </FadeContent>
        </div>
