  ...
  return (
    <div className="space-y-5">
      <header className="flex flex-wrap items-end justify-between gap-4 border-b border-[var(--border)] pb-5">
        <div>
          <p className="telemetry text-violet-300">LIVE MINERAL SCORE</p>
          <h1 className="mt-1 font-hud text-3xl font-bold tracking-[-0.04em] text-[var(--text-primary)]">Leaderboard</h1>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-3 text-xs text-[var(--text-secondary)]">
        <span className="telemetry text-[var(--success)]">LIVE · GENERATED AT + BASE RATE</span>
        <span className="font-mono">As of {asOfLabel(data.asOf)} UTC</span>
      </div>
