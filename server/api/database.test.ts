...
import { createPostgresPoolConfig } from './database';

describe('serverless Postgres pool configuration', () => {
  it('limits every Vercel function instance to one Supabase connection', () => {
  ...
  it('uses standard libpq TLS semantics for Supabase sslmode=require URLs', () => {
    expect(
